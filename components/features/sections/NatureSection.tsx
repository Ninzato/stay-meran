...
export function NatureSection() {
  const natureContent = mockSections.find(section => section.id === 'breathtaking-nature');
      ...
      <Container>
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            {/* Title */}
            <h2 className="text-foreground text-3xl font-bold md:text-4xl">{natureContent.title}</h2>

            {/* Description */}
            <p className="text-foreground/80 text-lg leading-relaxed">{natureContent.content}</p>
